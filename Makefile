...
CFLAGS= $(COMMON) -fobjc-abi-version=2 -fobjc-legacy-dispatch
...
install: test glestest
	cp test "$(HOME)/Library/Application Support/iPhone Simulator/3.2/Applications/awtest/awtest.app/awtest"
	cp test "$(HOME)/Library/Application Support/iPhone Simulator/3.2/Applications/gles/gles.app/gles"
